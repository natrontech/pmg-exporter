...
// simpleRESTClientGetter loads kubeconfig from memory instead of reading a local file
...
func (c *simpleRESTClientGetter) ToRESTMapper() (meta.RESTMapper, error) {
	...
	expander := restmapper.NewShortcutExpander(mapper, discoveryClient, func(s string) { slog.Warn(s) })
	return expander, nil
}
